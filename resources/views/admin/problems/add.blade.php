...
@section('content')
	 <div class="title-block">
        <h3> 添加问题 <span class="sparkline bar" data-type="bar"></span> </h3>
    </div>
     @if(count($errors) > 0)
		 	...
		 	<div class="col-md-10">
				<form action="{{url('/admin/problems')}}" method="POST" enctype="multipart/form-data">
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" name="ptitle" id="exampleInputEmail1" style="height=45px" value="">
				  </div>
				  <div class="form-group">
				    <label for="exampleInputEmail1">问题描述： </label>
				    <input type="text" class="form-control" name="pdescript" id="exampleInputEmail1" style="height=45px" value="">
				  </div>
				   <div class="form-group">
				    <label for="exampleInputFile">内容：</label>
                        ...
                        <script id="editor" name="pcontent" type="text/plain" style="width:850px;height:300px;"></script>
