...
function newBox() {
    jQuery.jdThickBox({
        ...
        width: 300,
        height:80,
        source: "<div class=\"tip-box icon-box\"><span class=\"succ-icon m-icon\"></span><div class=\"item-fore\"><h3 class=\"ftx02\">资料保存成功</h3><div class=\"op-btns\"><a href=\"javascript:void(0)\" class=\"btn-9\" onclick=\"window.location.reload()\">关闭</a></div></div></div>",
        _autoReposi: true
    });
}
...
function changeAliasName(){
    jQuery.ajax({
        ...
        success : function(html) {
            ...
            var html = "<span id='aliasNameBefore_msg'>登录名暂时无法修改</span><a class='ftx-05 ml10' target='_blank' href='https://safe.jd.com/validate/verifyMobile' clstag='pageclick|keycount|201602251|2'>请验证手机号码</a>"
